    ...
    <>
      ...
      <section className="flex lg:gap-6 pt-[42px] lg:pt-[68px]">
        <div>
          ...
          <ul className="text-[14px]/[20 px] lg:text-[18px]/[28px] font-medium  space-y-[10px] lg:space-y-3 list-disc ml-4">
        ...
        <div className="hidden lg:block w-full max-w-[506px] aspect-[5/3]">
          <a
            href="https://2gis.ru/novosibirsk/firm/70000001038917532"
            target="_blank"
            rel="noopener noreferrer"
            className="block rounded-[12px] overflow-hidden shadow-lg"
          >
            <img
