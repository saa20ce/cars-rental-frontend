...
const paragraphsSection4 = [
    ...
    'Доставка автомобиля к месту получения помогает сэкономить время: не нужно самостоятельно добираться до офиса проката.',
    ...
    return (
        <>
            ...
            <TextImageSection
                ...
                maxWidthText="574"
                maxWidthImage="618"
                header="Особенности аренды авто с доставкой"
                headingTag="div"
