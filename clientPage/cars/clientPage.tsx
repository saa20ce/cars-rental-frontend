    ...
    return (
        <>
            <section className="bg-[#f6f6f60e] rounded-3xl px-6 py-[28px] lg:py-[38px] lg:px-9">
                <header className="flex flex-col lg:flex-row lg:justify-between pb-6 lg:pb-8 border-b-[1px] border-[#f6f6f638] ">
                    <div className="w-full max-w-[610px]">
                        ...
                        <p className="hidden lg:block text-[18px]/[28px] font-medium">
                            ...
                            предоставить вам максимальный комфорт во время
                            поездки.
                        </p>
                    </div>
                ...
                <section className="mb-4 mt-6 lg:mt-8">
                    ...
                    {advancedVisible && (
                        <div className="select-group flex flex-col gap-[10px] lg:flex-row lg:gap-0">
                            ...
                            <CustomSelect
                                ...
                                style={{ width: '100%' }}
                                onChange={(value) =>
                                    setSelectedPrivod(value as string)
                                }
                            ...
                            <CustomSelect
                                ...
                                style={{ width: '100%' }}
                                onChange={(value) =>
                                    setSelectedPassangers(value as string)
                                }
                            ...
                            <CustomSelect
                                ...
                                style={{ width: '100%' }}
                                onChange={(value) =>
                                    setSelectedDvigatel(value as string)
                                }
                ...
                <section className="flex justify-between flex-wrap lg:justify-start lg:gap-3">
                    <CustomButton
                        variant="outlined"
                        icon={<FiltersIcon />}
