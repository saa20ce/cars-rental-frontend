...
export const RentalCheckout: React.FC<RentalCheckoutProps> = ({
  ...
  useEffect(() => {
    ...
    const modifiedOptions = [
      { label: 'Без подачи', value: 'none', price: 0 },
      ...options,
    ];
    setDeliveryOptions(modifiedOptions);
  ...
  return (
    <div className="lg:w-full">
      ...
      {showCost && (
        <div className="p-6 bg-[#f6f6f60e] mt-[-10px] z-0 relative rounded-b-2xl transition-all lg:px-7 lg:pb-8 lg:pt-11 lg:mt-[-28]">
          <div className="flex items-center mb-4">
            <h4 className="text-[20px]/[28px] lg:text-[24px]/[32px] font-bold">Расчет стоимости</h4>
          </div>
            ...
            <div className="text-sm lg:text-lg border-b border-[#f6f6f638]">
              {additionalOptions
                ...
                .map((opt) => (
                  <div
                    key={opt.value}
                    className="flex justify-between my-[6px] lg:my-[10px]"
                  >
                    <div>{opt.label}</div>
                    <div className="font-bold">{opt.price ?? 0} ₽</div>
                  </div>
                ))}
            </div>
          )}
          ...
          <div className="flex items-center justify-between mb-5 mt-8">
            ...
            <div className="font-bold text-2xl lg:text-4xl">{totalPrice} ₽</div>
          </div>
      ...
      >
        ...
        >
          {isSubmitted && (
            <div className="text-center p-6 text-white  flex-center">
              <div className='w-full max-w-[360px] lg:max-w-[515px] bg-[#284B63] rounded-[16px] py-7 px-6 lg:py-[38px] lg:px-9 '>
								<div className='lg:flex lg:flex-row lg:items-center lg:gap-6 lg:mb-9'>
									...
									<div className='flex flex-col lg:text-left'>
										...
										<span className="text-[16px]/[24px] lg:text-[18px]/[28px] font-semibold mb-2 tracking-normal text-nowrap">
											Мы свяжемся с вами в течение 5 минут
										</span>
										<span className="text-[14px]/[20px] lg:text-[16px]/[24px] font-normal mb-7 lg:mb-0">
