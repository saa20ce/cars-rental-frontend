...
export default function Breadcrumbs({
    ...
    return (
        <nav className="flex flex-wrap items-center bg-[#1e384a] py-[10px] px-5 lg:py-3 lg:px-7 rounded-[24px] text-[16px]/[24px] lg:text-[18px]/[28px] font-normal mb-[12px] lg:mb-5">
                ...
                return (
                    <div key={index} className="flex items-center">
                        {!isLast ? (
                            ...
                            <span className="font-bold text-[18px]/[28px] cursor-default">
                                {crumb.title}
                            </span>
                        )}
                    </div>
